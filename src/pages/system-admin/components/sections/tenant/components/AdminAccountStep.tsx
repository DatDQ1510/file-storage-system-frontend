...
export const AdminAccountStep = ({
  ...
  return (
    <section className="space-y-5 rounded-2xl border border-slate-200 bg-slate-50/60 p-4 shadow-sm sm:p-5">
      <div>
        <h4 className="text-lg font-semibold text-slate-900">Modal 2: Quan tri vien</h4>
        <p className="mt-1 text-sm text-slate-500">
          Tao tai khoan Root Admin voi thong tin dinh danh. Mat khau se duoc thiet lap sau qua link kich hoat.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-3 text-sm">
        {isCheckingAdminAvailability ? (
          <div className="flex items-center gap-2 text-slate-600">
            ...
            Dang kiem tra email va so dien thoai...
          </div>
        ) : adminAvailability ? (
          ...
          <p className="text-slate-500">Nhap email va so dien thoai hop le de kiem tra trung lap.</p>
        )}
      </div>
